...
import { HiOutlineBell, HiOutlineShoppingCart, HiOutlineUser } from 'react-icons/hi'
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-8">
        <div className="flex items-center justify-between h-14 lg:h-20">
          ...
          <div className="flex items-center gap-0.5">
            ...
            <Link to="/cart" className="relative p-2 text-[#1C1C1C] dark:text-gray-300 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors" aria-label="Cart">
