...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 w-full z-50 bg-cream-100/90 dark:bg-gray-900/90 backdrop-blur-md border-b border-cream-200 dark:border-gray-700">
