...
export default function AuthModal() {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
      ...
      <div className="relative bg-cream-100 rounded-2xl shadow-2xl w-full max-w-sm p-6 text-center border border-cream-200">
        <div className="w-12 h-12 mx-auto mb-3 rounded-xl bg-gold-100 flex items-center justify-center">
        ...
        <h3 className="font-display font-bold text-lg text-[#1C1C1C]">Sign In Required</h3>
        ...
        <div className="mt-6 flex flex-col gap-3">
          ...
          <button
            ...
            className="w-full border-2 border-emerald-600 text-emerald-600 py-2.5 rounded-xl font-body font-medium hover:bg-emerald-50 transition-colors"
          >
            Create Account
          </button>
          <button
            onClick={closeAuthModal}
            className="text-sm text-[#6B6B6B] hover:text-[#1C1C1C] transition-colors py-1"
          >
            Continue browsing
          </button>
        </div>
