      ...
      {submitted ? (
        ...
        <form onSubmit={handleSubmit} className="card p-6 space-y-5">
          ...
          <div>
            ...
            <div className="border-2 border-dashed border-cream-300 dark:border-gray-600 rounded-xl p-8 text-center hover:border-emerald-600 transition-colors cursor-pointer">
              <HiOutlineUpload className="w-8 h-8 text-[#6B6B6B] dark:text-gray-400 mx-auto mb-2" />
              <p className="text-sm text-[#6B6B6B] dark:text-gray-400">Drag & drop images here, or click to browse</p>
